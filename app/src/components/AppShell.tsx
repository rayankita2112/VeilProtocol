...
const MORE_ITEMS: NavItem[] = [
  { label: "Freighter", href: "/wallet/freighter", icon: Plug },
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden lg:flex flex-col w-60 border-r border-[#1e2329] bg-[#131722]">
        ...
        <Link
          href="/"
          className="flex items-center gap-3 px-6 h-16 border-b border-[#1e2329]"
        >
          <div className="h-8 w-8 rounded-lg bg-[#f7a600] flex items-center justify-center shadow-sm">
            <span className="text-[#0b0e11] font-black text-base font-mono tracking-tighter">
              V
            </span>
          </div>
          <div className="flex flex-col">
            <span className="text-sm font-bold tracking-tight text-[#eaecef]">
              Veil Pro
            </span>
            <span className="text-[10px] font-mono text-[#848e9c] uppercase tracking-widest">
              Shielded Desk
            </span>
          </div>
        </Link>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 border-b border-[#1e2329] flex items-center justify-between px-4 lg:px-6 bg-[#131722]">
          <Link href="/" className="lg:hidden flex items-center gap-2.5">
            <div className="h-8 w-8 rounded-lg bg-[#f7a600] flex items-center justify-center">
              <span className="text-[#0b0e11] font-black text-sm font-mono">
                V
              </span>
            </div>
        ...
        {/* Page content */}
        <main className="flex-1 overflow-y-auto bg-[#0b0e11]">{children}</main>
      </div>
