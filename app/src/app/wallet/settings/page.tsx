...
import { getVaultUsername, clearVaultUsername, saveVault } from "@/lib/vault";
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (!secret) {
                          setRecoveryError("Wallet is locked");
                          return;
                        }
                ...
                <>
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-orange-600">
                      Keep this secret key safe. Anyone with it can access your
                      funds.
                    </p>
                  </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-600 mt-1">
                    This will permanently delete all shielded notes. Unspent
                    funds will be lost if you haven't exported a backup.
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
