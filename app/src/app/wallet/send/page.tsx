          ...
          {!vk ? (
            <>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Generate a reveal key for this transaction. Share it only with
                an authorized reviewer so they can verify disclosed details
                after the timelock expires. The key cannot spend funds.
              </p>
          ...
          <div className="space-y-5">
            ...
            {mode === "shielded" && shieldedSub === "transfer" && (
              <div className="flex items-start gap-2.5 px-4 py-3 rounded-lg bg-[#0ecb81]/8 border border-[#0ecb81]/20">
                <Shield className="h-4 w-4 text-[#0ecb81] shrink-0 mt-0.5" />
                <p className="text-xs font-mono text-[#848e9c] leading-relaxed">
                  No on-chain transaction will be submitted. A claim link will
                  be generated for your recipient.
                </p>
              </div>
            )}
