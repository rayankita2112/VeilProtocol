...
const DEFAULT_POOL = process.env.NEXT_PUBLIC_POOL_CONTRACT_ID ?? "";
...
export async function GET(req: NextRequest) {
  ...
  const knownRoots = new Set(
    historicalRoots.filter((r) => r !== "0".repeat(64)),
  );
  ...
  // Find first mismatch
  const firstMismatch = results.find(
    (r) => !r.match && r.size <= treeState.nextIndex,
  );
  ...
  const candidates = [
    {
      ...
      val: BigInt(
        "0x" +
          "02bfdb7427b3eaf96030a39d2af9ac389d9909e7956c7d1fccd9afbcc29938c3",
      ),
    },
    {
      label: "2d65c072",
      val: BigInt(
        "0x" +
          "2d65c0726bd762449fe2be92134738f9207ad15c6c8bf82dab393e4b7b505dcc",
      ),
    },
    {
      label: "128fb0a2",
      val: BigInt(
        "0x" +
          "128fb0a2a7b88ed45f37dd5e2914e04306c4ebf6c1ff671967e2289354fd2645",
      ),
    },
  ];
