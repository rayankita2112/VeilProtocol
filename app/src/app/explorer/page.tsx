...
import { Shield, CheckCircle2, XCircle, Activity, Lock } from "lucide-react";
  ...
  return [
    ...
    },
    {
      ...
      publicInputs: {
        ...
        nullifierHash:
          "0x2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c",
      ...
      <div className="max-w-3xl mx-auto px-4 lg:px-6 py-6 pb-24 lg:pb-6">
        <div className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Every withdrawal on Veil is verified on-chain using a Groth16
            zero-knowledge proof. This page shows exactly what the Soroban
            verifier checks — the pairing equation, public inputs, and proof
            points. Nothing is hidden.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border/50 p-6 mb-8">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              The on-chain verifier receives a proof{" "}
            ...
            <ul className="list-disc ml-5 space-y-1 text-xs">
              <li>
                <strong>A, B, C</strong> — proof points from the prover (G1, G2,
                G1)
              </li>
              <li>
                <strong>α, β, γ, δ</strong> — verification key points (embedded
                in contract at deploy time)
              </li>
              <li>
                <strong>vk_x</strong> — linear combination of public inputs with
                IC points:{" "}
            ...
            <p>
              ...
              <code className="font-mono bg-muted px-1 rounded text-xs ml-1">
                bn254_g1_add
              </code>
              ,
              <code className="font-mono bg-muted px-1 rounded text-xs ml-1">
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${v.verified ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-600"}`}
                  >
                    {v.verified ? (
                ...
                <div
                  className={`text-xs font-medium px-2.5 py-1 rounded-full ${v.verified ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"}`}
                >
                ...
                <div className="border-t border-border/30 p-5 space-y-5 bg-muted/10">
                  ...
                  <div>
                    ...
                    <div className="text-center mt-1.5">
                      <span
                        className={`text-xs font-medium ${v.verified ? "text-emerald-600" : "text-red-600"}`}
                      >
                        {v.verified
                          ? "✓ Equation holds — proof is valid"
                          : "✗ Equation failed"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {Object.entries(v.publicInputs).map(([key, val]) => (
                        <div
                          key={key}
                          className="flex items-start gap-3 bg-background rounded-lg p-3 border border-border/30"
                        >
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-amber-800">
                        ...
                        <p className="text-amber-700">
                          The proof reveals nothing about: which deposit is
                          being withdrawn (the nullifier and secret are private
                          inputs), the Merkle path proving membership, or any
                          link between the depositor and recipient. Only the
                          root, nullifier hash, and recipient are public — and
                          the nullifier hash cannot be reversed to find the
                          deposit.
                        </p>
                      </div>
                    </div>
        ...
        <div className="mt-8 flex items-start gap-2 text-xs text-muted-foreground">
          ...
          <span>
            These are demo verifications showing the structure of on-chain proof
            data. In production, this page would index real Soroban contract
            events and display actual proof verifications from the pool
            contract.
          </span>
        </div>
      </div>
