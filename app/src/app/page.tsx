...
import { createTreeEventPoller } from "@/lib/event-stream.mjs";
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="h-8 w-8 rounded-lg bg-[#f7a600] flex items-center justify-center shadow-sm">
              <span className="text-[#0b0e11] font-black text-sm font-mono tracking-tighter">
                V
              </span>
            </div>
            <span className="text-base font-bold tracking-tight text-[#eaecef]">
              Veil
            </span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="rounded-full px-5 bg-[#f7a600] hover:bg-[#e09500] text-[#0b0e11] font-bold"
            asChild
          >
    ...
    <div className="mx-auto" style={{ width: 320 }}>
      ...
      <div className="rounded-[2.5rem] border-[3px] border-[#2a2e37] bg-[#0b0e11] p-2 shadow-2xl shadow-black/60">
        ...
        <div className="rounded-[2rem] overflow-hidden bg-[#0b0e11]">
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-[#1e2329] bg-[#131722]">
            <div className="flex items-center gap-2">
              <div className="h-6 w-6 rounded-md bg-[#f7a600] flex items-center justify-center">
                <span className="text-[#0b0e11] font-black text-[9px] font-mono">
                  V
                </span>
              </div>
          ...
          {/* Balance card */}
          <div
            className="mx-3 mt-3 rounded-xl overflow-hidden border border-[#1e2329] relative"
            style={{
              background: "linear-gradient(135deg, #1a1e26 0%, #131722 100%)",
            }}
          >
            ...
            <div className="p-4 pt-5">
              ...
              <div className="text-2xl font-mono font-black tracking-tight text-[#eaecef] mb-2">
                1,250.00
              </div>
              <div className="flex items-center gap-1.5 mb-2">
                <span className="text-[8px] font-mono font-bold text-[#eaecef] bg-[#181c25] border border-[#1e2329] rounded-full px-2 py-0.5">
                  1,000 XLM
                </span>
                <span className="text-[8px] font-mono font-bold text-[#eaecef] bg-[#181c25] border border-[#1e2329] rounded-full px-2 py-0.5">
                  250 USDC
              ...
              <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-[#0b0e11]/50 border border-[#1e2329]">
                <span className="text-[8px] font-mono tracking-wider text-[#848e9c] truncate">
                  GABC DEFG HIJK LMNO
                </span>
          ...
          <div className="flex gap-2 mx-3 mt-3">
            {[
              ...
              <div
                key={a.label}
                className="flex-1 flex flex-col items-center gap-1.5 p-2.5 rounded-xl border border-[#1e2329] bg-[#131722]"
              >
                <div className="h-7 w-7 rounded-lg bg-[#181c25] border border-[#1e2329] flex items-center justify-center text-[#eaecef]">
                  <a.icon className="h-3 w-3" />
                </div>
                <span className="text-[8px] font-mono font-medium text-[#848e9c]">
                  {a.label}
                </span>
              </div>
            ))}
          ...
          <div className="mx-3 mt-3 rounded-xl border border-[#1e2329] bg-[#131722]">
            <div className="flex items-center justify-between px-3 py-2 border-b border-[#1e2329]">
              <span className="text-[8px] font-mono font-bold text-[#eaecef] uppercase tracking-wider">
                Recent Activity
              </span>
          ...
          <div className="flex items-center justify-around mt-3 px-2 py-2.5 border-t border-[#1e2329] bg-[#131722]">
            {[
              ...
              >
                <tab.icon
                  className={`h-4 w-4 ${tab.active ? "text-[#f7a600]" : "text-[#848e9c]"}`}
                />
                <span
                  className={`text-[7px] font-mono font-bold uppercase tracking-wider ${tab.active ? "text-[#f7a600]" : "text-[#848e9c]"}`}
                >
                  {tab.label}
                </span>
              </div>
...
function MobileTxRow({
  ...
  const config = {
    deposit: {
      icon: <ArrowDownLeft className="w-2.5 h-2.5" />,
      bg: "bg-[#0ecb81]/15 text-[#0ecb81]",
      color: "text-[#0ecb81]",
      label: "Received",
    },
    withdraw: {
      icon: <ArrowUpRight className="w-2.5 h-2.5" />,
      bg: "bg-[#f7a600]/15 text-[#f7a600]",
      color: "text-[#f7a600]",
      label: "Sent",
    },
    swap: {
      icon: <ArrowLeftRight className="w-2.5 h-2.5" />,
  ...
  return (
    <div className="flex items-center justify-between px-3 py-2">
      <div className="flex items-center gap-2">
        <div
          className={`w-5 h-5 rounded-full flex items-center justify-center ${c.bg}`}
        >
          {c.icon}
        </div>
        <div>
      ...
      <div className={`text-[9px] font-mono font-semibold ${c.color}`}>
        {amount}
      </div>
    </div>
  );
  ...
  useEffect(() => {
    const poller = createTreeEventPoller({
      ...
      onError: () => {
        setStats((current) => ({
          ...current,
          network: current.network || "testnet",
        }));
      },
    });

    poller.start();
    window.addEventListener("online", poller.handleOnline);
    ...
    return () => {
      poller.stop();
      window.removeEventListener("online", poller.handleOnline);
  ...
  return (
    <div className="min-h-screen bg-[#0b0e11] text-[#eaecef]">
      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, #f7a600 0%, transparent 70%)",
              }}
            />
            <div
          ...
          <div className="relative z-10 flex flex-col items-center px-6 pt-20 pb-16">
            ...
            >
              ...
              <br />
              <span className="italic font-normal text-[#f7a600]">
                Transfer & Swap
              </span>{" "}
              <span>privately.</span>
            </motion.h1>
            ...
            >
              The confidential wallet and DEX swap layer for Stellar. Transfer
              instantly or swap assets on-chain with zero public link between
              sender and receiver.
            </motion.p>
            ...
            >
              <Button
                size="lg"
                className="rounded-full px-7 gap-2 bg-[#f7a600] hover:bg-[#e09500] text-[#0b0e11] font-bold shadow-lg shadow-[#f7a600]/15"
                asChild
              >
                <Link href="/wallet">
                  Get Started
              ...
              <Button
                variant="outline"
                size="lg"
                className="rounded-full px-7 gap-2 border-[#1e2329] text-[#eaecef] hover:bg-[#181c25] hover:text-[#eaecef]"
                asChild
              >
            ...
            >
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 rounded-xl border border-[#1e2329] bg-[#131722]/80 p-2 backdrop-blur">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-lg bg-[#181c25]/60 px-3 py-2 text-center"
                  >
                    <div className="text-[9px] font-mono font-bold uppercase tracking-wider text-[#848e9c]">
                      {label}
                    </div>
                    <div className="mt-0.5 text-sm font-bold text-[#eaecef]">
                      {value}
                    </div>
                  </div>
                ))}
              ...
              {stats.network && (
                <p className="mt-3 text-center text-xs text-[#848e9c]">
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    Live on Stellar {stats.network} — proofs verify on-chain in
                    ~5 seconds
                  </span>
                </p>
              )}
        ...
        <section
          id="how-it-works"
          className="px-6 py-24 border-t border-[#1e2329]"
        >
            ...
            <FadeIn>
              <div className="text-center mb-14">
                ...
                <p className="text-[#848e9c] max-w-2xl mx-auto">
                  Deposit into a shielded pool, send privately or swap assets —
                  no public link between sender and receiver.
                </p>
              </div>
            </FadeIn>
          ...
          <div className="max-w-5xl mx-auto">
            <FadeIn>
              <div className="text-center mb-14">
                ...
                <p className="text-[#848e9c] max-w-2xl mx-auto">
                  On-chain ZK proofs, client-side proving, and
                  compliance-oriented disclosure.
                </p>
              </div>
            </FadeIn>
          ...
          <div className="max-w-5xl mx-auto">
            <FadeIn>
              <div className="text-center mb-14">
                ...
                <p className="text-[#848e9c] max-w-2xl mx-auto">
                  The privacy pipeline — from deposit commitment to
            ...
            <FadeIn delay={0.2}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                <div className="rounded-xl border border-[#1e2329] bg-[#131722] p-5">
                  <h3 className="font-semibold text-[#eaecef] mb-3">
                    Tech Stack
                  </h3>
                ...
                <div className="rounded-xl border border-[#1e2329] bg-[#131722] p-5">
                  ...
                  <ul className="space-y-2 text-sm text-[#848e9c]">
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-[#0ecb81] shrink-0" />{" "}
                      No public sender-recipient link
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-[#0ecb81] shrink-0" />{" "}
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-[#0ecb81] shrink-0" />{" "}
                      Timelocked reveal keys for auditors
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-[#0ecb81] shrink-0" />{" "}
                      Privacy Pools subset compliance
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-[#848e9c] mb-8">
                Deposit stablecoins, send privately, or execute DEX swaps — all
                with selective disclosure for compliance.
              </p>
              <div className="flex items-center justify-center gap-3">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/compliance">Try Compliance Demo</Link>
                </Button>
              </div>
            </div>
          </FadeIn>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="flex items-center gap-2.5">
                <div className="h-7 w-7 rounded-lg bg-[#f7a600] flex items-center justify-center">
                  <span className="text-[#0b0e11] font-black text-xs font-mono">
                    V
                  </span>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-[#848e9c]">
                <Link
                  href="/wallet"
                  className="hover:text-[#eaecef] transition-colors"
                >
                  Wallet
                </Link>
                <Link
